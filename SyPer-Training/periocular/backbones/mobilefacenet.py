'''
code from https://github.com/cavalleria/cavaface.pytorch/blob/master/backbone/mobilefacenet.py
'''
import copy
...
class GDC(Module):
    def __init__(self, embedding_size):
        ...
        self.conv_6_dw = Linear_block(
            512, 512, groups=512, kernel=(14, 14), stride=(1, 1), padding=(0, 0)
        )
...
def get_mobilefacenet(num_features=512):
    return MobileFaceNet(input_size=(224,224), embedding_size=num_features)

class MobileFaceNet(Module):
    def __init__(
        self, input_size=(224,224), embedding_size=512, output_name="GDC", attention="none"
    ):
        super(MobileFaceNet, self).__init__()
        assert output_name in ["GNAP", "GDC"]
        assert input_size[0] in [224]
