    ...
    for model in types_models:
        for fold in [1,2,3]:
            for q_level in [8, 6, 4]:
                ...
                config.results_file = f"{config.results_path}/{model}_id_f-all_w{q_level}a{q_level}_synffhqgan{flipping}.txt"
                ...
                with open(f"./synffhqgan_identification/config_id_synffhqgan_test_{r:05d}.pkl", "wb") as f:
