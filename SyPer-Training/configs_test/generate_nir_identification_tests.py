        ...
        for fold in [1,2,3]:
            for q_level in [8, 6, 4]:
                ...
                for step in steps:
                    ...
                    config.results_file = f"{config.results_path}/{model}_id_f-all_w{q_level}a{q_level}_nir{flipping}.txt"
                    ...
                    with open(f"./nir_identification/config_id_nir_test_{r:05d}.pkl", "wb") as f:
