        ...
        for fold in [1,2,3]:
            for q_level in [8, 6, 4]:
                ...
                for step in steps:
                    ...
                    config.results_file = f"{config.results_path}/{model}_ver_f-all_w{q_level}a{q_level}_nirxspectrum{flipping}.txt"
                    ...
                    with open(f"./xspectrum_verification/config_ver_nirxspectrum_test_{r:05d}.pkl", "wb") as f:
