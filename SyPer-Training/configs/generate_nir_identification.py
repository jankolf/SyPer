...
if __name__ == "__main__":
    ...
    config.train_dataset_path = "/data/jkolf/PeriocularExtension/data/CASIA-Cropped"
    ...
    for model in types_models:
        for fold in [1,2,3]:
            ...
            for q_level in [8, 6, 4]:
                ...
                config.model_folder = f"nir_identification"
                ...
                with open(f"./nir_identification/config_id_nir_train_{r:05d}.pkl", "wb") as f:
